...
const enhancedModules: Module[] = [
  ...
  },
  {
    ...
    category: 'processing',
    io: {
      inputs: [{ type: 'products', required: true }],
      outputs: [{ type: 'products', schema: { name: 'string', price: 'number', description: 'string', category: 'string', standardized: 'boolean' }, required: true }]
    },
    configFields: [
  ...
  },
  {
    ...
    isLLMPowered: true,
    io: {
      inputs: [{ type: 'products', required: false }, { type: 'customers', required: false }],
      outputs: [{ type: 'customers', schema: { name: 'string', phone: 'string', interest: 'string', status: 'string' }, required: true }]
    },
    configFields: [
  ...
  },
  {
    ...
    isLLMPowered: true,
    io: {
      inputs: [{ type: 'products', required: false }],
      outputs: [{ type: 'customers', schema: { name: 'string', email: 'string', interest: 'string', chatLog: 'array' }, required: true }]
    },
    configFields: [
  ...
  },
  {
    ...
    isLLMPowered: true,
    io: {
      inputs: [{ type: 'products', required: true }, { type: 'customers', required: true }],
      outputs: [{ type: 'quotes', schema: { customerId: 'string', products: 'array', totalPrice: 'number', validUntil: 'date' }, required: true }]
    },
    configFields: [
  ...
  },
  {
    ...
    isLLMPowered: true,
    io: {
      inputs: [{ type: 'quotes', required: true }, { type: 'customers', required: true }],
      outputs: [{ type: 'emails', schema: { to: 'string', subject: 'string', sent: 'boolean', opened: 'boolean' }, required: true }]
    },
    configFields: [
  ...
  },
  {
    ...
    isLLMPowered: true,
    io: {
      inputs: [{ type: 'emails', required: false }, { type: 'quotes', required: false }, { type: 'customers', required: false }],
      outputs: [{ type: 'analytics', schema: { conversionRate: 'number', revenue: 'number', topProducts: 'array' }, required: true }]
    },
    configFields: [
  ...
  },
  {
    ...
    isLLMPowered: true,
    io: {
      inputs: [{ type: 'products', required: true }, { type: 'analytics', required: false }],
      outputs: [{ type: 'reports', schema: { marketAnalysis: 'object', competitors: 'array', recommendations: 'array' }, required: true }]
    },
    configFields: [
  ...
  },
  {
    ...
    io: {
      inputs: [{ type: 'products', required: false }, { type: 'customers', required: false }, { type: 'quotes', required: false }],
      outputs: [{ type: 'sync_data', schema: { division: 'string', syncedRecords: 'number', status: 'string' }, required: true }]
    },
    configFields: [
  ...
  },
  {
    id: 'human-decision',
    name: 'Human Decision',
    description: 'Pause the automation for manual review, approval, or decision-making. No data input required.',
    icon: '👤',
    category: 'decision',
    io: {
      inputs: [{ type: 'products', required: false }, { type: 'customers', required: false }, { type: 'quotes', required: false }, { type: 'analytics', required: false }],
      outputs: [{ type: 'approval', schema: { approved: 'boolean', approver: 'string', notes: 'string', timestamp: 'date' }, required: true }]
    },
    configFields: [
      ...
      { name: 'decisionType', label: 'Decision Type', type: 'text', placeholder: 'Approval, Review, Go/No-Go' }
    ]
  },
  {
    id: 'discount-pricing',
    ...
    isLLMPowered: true,
    io: {
      inputs: [{ type: 'customers', required: true }, { type: 'products', required: true }],
      outputs: [{ type: 'pricing', schema: { customerId: 'string', discountPercentage: 'number', finalPrice: 'number', strategy: 'string' }, required: true }]
    },
    configFields: [
  ...
  {
    id: 'human-manual-input',
    name: 'Human Manual Input',
    description: 'Pause the workflow for manual data entry, custom information input, or human intervention.',
    icon: '✋',
    category: 'decision',
    io: {
      inputs: [{ type: 'products', required: false }, { type: 'customers', required: false }, { type: 'quotes', required: false }],
      outputs: [{ type: 'customers', schema: { manualData: 'object', inputBy: 'string', timestamp: 'date' }, required: true }]
    },
    configFields: [
      { name: 'inputType', label: 'Input Type', type: 'text', placeholder: 'Customer details, Product specifications, etc.' },
      { name: 'instruction', label: 'Input Instructions', type: 'textarea', placeholder: 'Please enter the required information...' },
      { name: 'requiredFields', label: 'Required Fields', type: 'textarea', placeholder: 'name, email, phone, notes' },
      { name: 'assignee', label: 'Assigned To', type: 'text', placeholder: 'sales@company.com' }
    ]
  }
];

export async function initializeEnhancedModules() {
  try {
  ...
  await fs.writeFile(MODULES_FILE, JSON.stringify(enhancedModules, null, 2));
  console.log('Enhanced modules with I/O schemas initialized');
}

export { enhancedModules };